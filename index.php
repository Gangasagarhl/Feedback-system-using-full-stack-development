...
<!--heading part has to be included-->
               <div> 
...
<!--this a-->
        ...
        <div style="">      
            ...
            <a href="admin.php">
              <section style="background-image: url(d3.jpg);width: 20%;height: 25%;float: left;margin-left: 10%;opacity: 0.9">
              <div style="width: 100%;height: 100%   background: rgba(0,0,0,0.5);">
                 <h1 style="margin-top:">Admin</h1>
              </div>
              </section >
            </a>
              ...
              <a href="faculty.php ">
              <section style="background-image: url(image.jpg);width: 20%;height: 25%; float: left;margin-left: 10%">
              ...
              <a href="student.php">
              <section style="background-image: url(d1.jpg);width: 20%;height: 25%;float: left ;margin-left: 3% ;margin-left:10% " >
              <div style="width: 100%;height: 100%">
                 <h1 >Student</h1>
              </div>
              </section>
